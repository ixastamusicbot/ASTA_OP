...
# Git
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ixastamusicbot/ASTA_OP")
...
API_KEY = getenv("API_KEY", 'NxGBNexGenBotsb069e5') # youtube song api key, generate free key or buy paid plan from panel.thequickearn.xyz
